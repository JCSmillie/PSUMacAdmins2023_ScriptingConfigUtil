...
echo "-------------------------"
echo "Type of iPad-> $deviceType"
echo "ECID-> $ECID"
echo "UDUD-> $UDID"
echo "Location-> $locationID   <--This is the location of the device according to the USB tree."
echo "Name-> $deviceName   <--Name of the device currently."
echo "Build Version of iPadOS-> $buildVersion"
echo "Firmware Version of iPad-> $firmwareVersion"
